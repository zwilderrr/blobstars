				...
				<div>
					<div>
						...
						<p>
							...
							of your Rockstar / NFT, provided that the marketplace
							cryptographically verifies each Rockstar owner’s rights to display
							the Art for their Rockstar to ensure that only the actual owner
							can display the Art; or (iii) as part of a third party website or
							application that permits the inclusion, involvement, or
							participation of your Rockstar, provided that the
							website/application cryptographically verifies each Rockstar
							owner’s rights to display the Art for their Rockstar to ensure
						...
						<p>
							...
							verifies each Rockstar owner’s rights to display the Art for their
							Rockstar to ensure that only the actual owner can display the Art;
							(ii) owning or operating a third party website or application that
							permits the inclusion, involvement, or participation of Rockstars
							generally, provided that the third party website or application
							cryptographically verifies each Rockstar owner’s rights to display
							the Art for their Rockstar to ensure that only the actual owner
							can display the Art, and provided that the Art is no longer
							visible once the owner of the Purchased Rockstar leaves the
						...
						<p>
							...
							ability to reverse any transactions.&nbsp; We will have no
						...
						<p>
							...
							nature of the project, Rockstars has not been registered with or
							approved by any regulator in any jurisdiction. It remains your
							sole responsibility to assure that the purchase of the Rockstar
